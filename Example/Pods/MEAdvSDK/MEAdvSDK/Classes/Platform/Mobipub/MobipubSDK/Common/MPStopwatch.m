...
@property (nonatomic, strong) MobiTimer * timer;
@end
...
- (void)start {
    ...
    self.duration = 0.0;
    self.timer = [MobiTimer timerWithTimeInterval:kStopwatchStep target:self selector:@selector(onTimerFired) repeats:YES runLoopMode:NSRunLoopCommonModes];
