...
@property (nonatomic, strong) MobiTimer *clickThroughEnablingTimer;
...
- (void)setUpClickthroughForOffset:(NSTimeInterval)skipOffset videoDuration:(NSTimeInterval)videoDuration {
    ...
    self.clickThroughEnablingTimer = [MobiTimer timerWithTimeInterval:MIN(skipOffset, videoDuration)
                                                             target:self
