...
{
    [(UIViewController *)controller dismissViewControllerAnimated:Mobi_ANIMATED completion:nil];
}

- (void)productViewControllerDidFinish:(SKStoreProductViewController *)viewController
{
    [viewController dismissViewControllerAnimated:Mobi_ANIMATED completion:nil];
}
