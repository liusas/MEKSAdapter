...
// Commands Constants
#warning 每次更改域名都要改这里哦
//static NSString * const kMoPubURLIP = @"161.117.226.147";//mobirtb
static NSString * const kMoPubURLIP = @"mycrtb";
...
//    return [[self scheme] isEqualToString:kMoPubURLScheme];
    return [self.absoluteString containsString:kMoPubURLIP];
}
