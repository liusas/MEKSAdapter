...
@property (nonatomic) MobiTimer *viewVisibilityTimer;
...
{
    if (self = [super init]) {
        _viewVisibilityTimer = [MobiTimer timerWithTimeInterval:kImpressionTimerInterval
                                                       target:self
