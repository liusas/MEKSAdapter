...
- (void)performActionForMoPubSpecificURL:(NSURL *)URL
{
#warning 暂时这么写,因为我们没有添加任何命令在 url 中
...
- (void)interceptURL:(NSURL *)URL
{
    ...
    if (self.configuration.clickTrackingURLs.count && !self.didFireClickImpression) {
...
//                          [[URL absoluteString] mp_URLEncodedString]];
        redirectedURL = [NSURL URLWithString:URL.absoluteString];
    }
