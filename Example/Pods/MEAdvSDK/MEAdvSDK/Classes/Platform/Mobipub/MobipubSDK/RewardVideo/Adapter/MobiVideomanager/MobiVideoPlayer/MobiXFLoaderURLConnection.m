...
@interface MobiXFLoaderURLConnection ()<MobiXFVideoRequestTaskDelegate>
...
@implementation MobiXFLoaderURLConnection
...
- (void)dealWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest
{
    ...
    if (!self.task) {
        self.task = [[MobiXFVideoRequestTask alloc] init];
