...
- (void)managerWillPresentModal:(MPInterstitialAdManager *)manager {
    if ([self.delegate respondsToSelector:@selector(interstitialWillPresentModal:)]) {
        [self.delegate interstitialWillPresentModal:self];
    }
}

- (void)managerDidDismissModal:(MPInterstitialAdManager *)manager {
    if ([self.delegate respondsToSelector:@selector(interstitialWillPresentModal:)]) {
        [self.delegate interstitialWillPresentModal:self];
    }
}
...
//    [MobiPub sendImpressionDelegateAndNotificationFromAd:self
