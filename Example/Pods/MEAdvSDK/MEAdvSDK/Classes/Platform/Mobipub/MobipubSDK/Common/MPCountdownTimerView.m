...
@property (nonatomic, strong) MobiTimer * timer; // timer instantiation is deferred to `start`
...
- (void)start {
    ...
    // Fire the timer
    self.timer = [MobiTimer timerWithTimeInterval:kCountdownTimerInterval
                                         target:self
...
#pragma mark - MobiTimer

- (void)onTimerUpdate:(MobiTimer *)sender {
    // Update the count.
