...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :git => 'https://github.com/liusas/MEKSAdapter.git', :tag => s.version.to_s }
...
#  s.vendored_framework = 'MEKSAdapter-1.0.5/ios/*.framework'
